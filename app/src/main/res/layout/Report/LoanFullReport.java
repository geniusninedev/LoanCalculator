package com.example.geniusnine.loancalculator.Report;
...
import com.example.geniusnine.loancalculator.Amortization.AmortizationCalculation;
import com.example.geniusnine.loancalculator.R;
...
public class LoanFullReport extends AppCompatActivity {
    ...
    com.example.geniusnine.loancalculator.Amortization.AmortizationAdapter amortizationAdapter;
    @Override
    ...
    private void loanAmortizationCalcualtion() {
        ...
        amortizationAdapter = new com.example.geniusnine.loancalculator.Amortization.AmortizationAdapter(this,results);
